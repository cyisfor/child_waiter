...
bool waiter_wait(const sigset_t* sigmask, struct pollfd* poll, int npoll, time_t sec);
...
bool waiter_waitfor(sigset_t* sigmask, time_t timeout, int expected, int *status);
